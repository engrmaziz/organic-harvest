    ...
    return (
        <div className="fixed bottom-6 left-6 z-50 flex items-center gap-4">
            <a
                ...
                className="relative bg-[#25D366] text-white p-3.5 rounded-full shadow-xl hover:bg-[#128C7E] transition-all flex items-center justify-center hover:scale-110 active:scale-95 duration-200 group"
            >
                <div className="absolute inset-0 rounded-full bg-[#25D366] animate-ping opacity-30 group-hover:opacity-0 transition-opacity duration-300"></div>
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-9 h-9 relative z-10" xmlns="http://www.w3.org/2000/svg">
